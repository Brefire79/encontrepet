/**
 * [FIX M10] Movido de js/icon-generator.js — script de DESENVOLVIMENTO apenas.
 *
 * Gera icones PWA em runtime via canvas. Nao e referenciado pelo index.html
 * em producao (os PNGs ja estao em /icons/). Mantido em scripts/ para
 * regeneracao futura se a identidade visual mudar.
 *
 * Para regenerar icones, abra um HTML que inclua este script e os PNGs
 * gerados podem ser baixados pelos <link rel="icon"> injetados no head.
 */
